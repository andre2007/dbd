...
procedure setPropertyInt64(Reference: Pointer; const AName: PAnsiChar;
  const value: Int64); stdcall;

function getPropertyInt64(Reference: Pointer; const AName: PAnsiChar)
  : Int64; stdcall;

procedure setPropertyUInt64(Reference: Pointer; const AName: PAnsiChar;
  const value: UInt64); stdcall;

function getPropertyUInt64(Reference: Pointer; const AName: PAnsiChar)
  : UInt64; stdcall;
...
procedure getPropertySet(Reference: Pointer; const AName: PAnsiChar;
  out value: WideString); stdcall;

function getIntegerIndexedPropertyReference(Reference: Pointer;
  const AName: PAnsiChar; const Index: Integer): Pointer; stdcall;

exports setPropertyEnum, getPropertyEnum, setPropertySet, getPropertySet, setPropertyReference,
  ...
  getPropertyCardinal, setPropertyInt64, getPropertyInt64,
  setPropertyUInt64, getPropertyUInt64,
  getPropertyString, getIntegerIndexedPropertyReference,
  getPropertyStruct;
...
function getPropertyInt64(Reference: Pointer; const AName: PAnsiChar)
  : Int64; stdcall;
begin
  result := getPropertyValue(Reference, string(AName)).AsType<Int64>;
end;
...
function getPropertyUInt64(Reference: Pointer; const AName: PAnsiChar)
  : UInt64; stdcall;
begin
  result := getPropertyValue(Reference, string(AName)).AsType<UInt64>;
end;
...
{   context := TRttiContext.Create;
  try
   ...
   // SetToString(prop.PropertyType.Handle)
